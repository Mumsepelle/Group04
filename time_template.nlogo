...
to setup
  ...
  set weekdayCounter 0
  initTime

  set timeTaker-stop-time 0
  set flag? true
...
to go
  ...
  ;EXAMPLE OF HOW TO TEST timeTaker, USES flag? ONLY HERE FOR THE TEST CIRCUMSTANCES.
  if flag?
  [
    set timeTaker-stop-time timeTaker 0 30
    set flag? false
  ]
...
to timeWrapAround
  ...
  [
    set weekdayCounter weekdayCounter + 1
    repeat 420
    [tick]
    set time-simulated (word (time:difference-between sim-start-time sim-time "minute") " minutes")
  ]
