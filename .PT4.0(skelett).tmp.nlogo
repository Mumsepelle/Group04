...
;_______________________________________SETUP___________________________________________________
to setup
  clear-all
  ...
  [
    user-message (word "The sum of INITIAL-COP-DENSITY and INITIAL-AGENT-DENSITY " "should not be greater than 100.")
    stop
  ]
...
;_____________________________________GO_____________________________________________________
to go
  ask turtles
  [
...
;_____________________________________MOVE_____________________________________________________
...
;________________________________________AGENT__________________________________________________
to agent_behavior

  ifelse state = "Updating beliefs"
  [
    ;read_environment
    ;set_variables

    set next_state "Deliberating"
  ]
  [
;-------------------------------------------
    ifelse state = "Deliberating"
    [
      ;set active? _____
      ...
      [
        ifelse active? = true
        [
          set goal_state "Rebel"
        ]
        ;else actice? = false
        [
          set goal_state "Chill"
        ]
      ]
      ;else jail_sentence > 0
      [
        set goal_state "Serve sentence"
      ]

      set next_state "Means-ends-reasoning"
    ]
;-------------------------------------------
    ;else state = "Means-ends-reasoning"
    [
      ;ALTERNATIVT ATT KÖRA PÅ PLANEN I M-E-R TILLS MAN BLIR ARRESTERAD
      ;set next_state "Updating beliefs"

      ifelse goal_state = "Rebel"
      [

      ]
      [
        ifelse goal_state = "Chill"
        [

        ]
        ;else goal state = "Serve sentence"
        [
          j
        ]
      ]
...
;________________________________________COP__________________________________________________
; COP BEHAVIOR
to enforce
...
;_________________________________________GRAPHICS_________________________________________________
